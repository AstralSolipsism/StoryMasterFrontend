<template>
  <div class="characters-container">
    <div class="h-full flex flex-col md:flex-row gap-6">
      ...
      <aside class="w-full md:w-64 glass-panel-md p-4 flex flex-col md:h-[calc(100vh-100px)]">
      ...
      <!-- Main Content Area -->
      <div class="flex-grow md:h-[calc(100vh-100px)] overflow-y-auto custom-scrollbar relative glass-panel-sm">
